...
if %ERRORLEVEL% EQU 0 (
    ...
    pwsh.exe -ExecutionPolicy Bypass -File "%~dp0packages\scripts\SearxQueriesUI.ps1"
) else (
    echo Using Windows PowerShell...
    powershell.exe -ExecutionPolicy Bypass -File "%~dp0packages\scripts\SearxQueriesUI.ps1"
)
